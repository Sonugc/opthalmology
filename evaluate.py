...
from model.densenet import DenseNet201Model
...
def plot_confusion_matrix(conf_matrix):
    ...
    plt.savefig(f"artifact/confusion_matrix.png")
    plt.close()

def save_classification_report(class_report):
    report_path = f"artifact/classification_report.txt"
...
if __name__ == "__main__":
    ...
    # Load checkpoint
    checkpoint_path = r"artifact\best_model.pth"
